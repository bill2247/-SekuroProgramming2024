...
if("TRUE" STREQUAL "TRUE")
  set(tutorial2_SOURCE_PREFIX /home/sabil2347/tutorials/src/tutorial2)
  set(tutorial2_DEVEL_PREFIX /home/sabil2347/tutorials/devel)
  ...
  set(tutorial2_INSTALL_PREFIX /home/sabil2347/tutorials/install)
...
if(NOT "/home/sabil2347/tutorials/devel/include " STREQUAL " ")
  set(tutorial2_INCLUDE_DIRS "")
  set(_include_dirs "/home/sabil2347/tutorials/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tutorial2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sabil2347/tutorials/src/tutorial2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sabil2347/tutorials/devel/lib;/opt/ros/noetic/lib)
